...
CREATE TABLE Automobile.Bajaj1 (
    Date  date ,
    Close_Price double,
    20_Day_MA double,
    50_Day_MA double
...
CREATE TABLE Automobile.Eicher1 (
    Date  date ,
    Close_Price double,
    20_Day_MA double,
    50_Day_MA double
...
CREATE TABLE Automobile.Infosys1 (
    Date  date ,
    Close_Price double,
    20_Day_MA double,
    50_Day_MA double
...
CREATE TABLE Automobile.Master_Table (
     Date date,
     Bajaj double,
     TCS double,
     TVS  double,
...
CREATE TABLE Automobile.bajaj2 (
    Date  date ,
    Close_Price double,
    `Signal` varchar(10)
);
...
CREATE TABLE Automobile.Eicher2 (
    Date  date ,
    Close_Price double,
    `Signal` varchar(10)
);
...
CREATE TABLE Automobile.Infosys2 (
    Date  date ,
    Close_Price double,
    `Signal` varchar(10)
);
...
begin 
    ...
    select `signal` into  `signal2` from `Automobile`.bajaj2 where date = `a`; 
	RETURN `signal2`;
END$$
DELIMITER ;
